let ELIGIBLE_MODEL_ID = ['lumi.sensor_ht'];
...
module.exports = {
	...
	values: {
		...
		temperature: { type:'float',  attribute: {id: '0x0001 0x0402 0x0000', toValue: ((attrval) => typeof(attrval) === 'number' ? (attrval/100) : undefined) }, unit: '%'  },
		humidity:    { type:'float',  attribute: {id: '0x0001 0x0405 0x0000', toValue: ((attrval) => typeof(attrval) === 'number' ? (attrval/100) : undefined) }, unit: '%'  , min:-0,  max: 100  },
	},
